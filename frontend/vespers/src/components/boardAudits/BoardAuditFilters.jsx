...
const BoardAuditFilters = ({
  ...
  const ACTIONS = ["created", "updated", "archived", "unarchived", "moved_to_trash", "restored_from_trash", "permanently_deleted"];
    ...
    >
      ...
      <div className="md:col-span-2 relative z-10">
        <label className="text-xs text-yellow-100/80 mb-1 block">
          Search (user, board, action)
        </label>
        <input
          value={search}
          onChange={(e) => setSearch(e.target.value)}
          onBlur={resetAndRefetch}
          placeholder="e.g., Alice, Project Alpha, Created"
...
export default BoardAuditFilters;
