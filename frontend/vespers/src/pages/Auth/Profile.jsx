  ...
  return (
    <div className="h-screen flex items-center justify-center bg-gradient-to-br from-gray-950 via-emerald-950 to-emerald-900 overflow-hidden">
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-5xl mx-4 md:mx-8 rounded-3xl overflow-hidden shadow-[0_8px_40px_rgba(0,0,0,0.45)]"
      >
        <div className="flex flex-col md:flex-row bg-[rgba(255,255,255,0.05)] backdrop-blur-xl border border-white/10">
          ...
          <div className="w-full md:w-1/2 p-6 md:p-8 lg:p-10 flex flex-col justify-center">
            ...
            <form onSubmit={handleSubmit} className="mt-5 space-y-3">
              ...
              {success && (
                <div className="text-sm text-emerald-200 bg-emerald-700/30 px-3 py-2 rounded-lg">
                  {success}
                </div>
              )}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <label className="block">
                  ...
                  <input
                    ...
                    value={form.dob}
                    onChange={handleChange}
                    className="mt-1 w-full px-3 py-2 rounded-xl bg-white/5 border border-white/10 text-white/90 focus:outline-none focus:ring-2 focus:ring-emerald-400/40"
                  />
                </label>
                ...
                <label className="block">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className="mt-1 w-full px-3 py-2.5 rounded-xl bg-white/5 border border-white/10 text-white/90 focus:outline-none focus:ring-2 focus:ring-emerald-400/40 appearance-none cursor-pointer hover:bg-white/10"
                  >
                ...
                <label className="block sm:col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows="3"
                    className="mt-1 w-full px-3 py-2 rounded-xl bg-white/5 border border-white/10 text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-emerald-400/40 resize-none"
              ...
              <motion.button
                ...
                type="submit"
                disabled={loading}
                className="w-full mt-3 py-2 rounded-xl text-gray-900 font-semibold bg-[linear-gradient(120deg,#34d399,#06b6d4,#34d399)] bg-[length:200%_100%] animate-shimmer shadow-lg"
              >
          ...
          <div className="hidden md:flex w-1/2 items-center justify-center bg-[linear-gradient(180deg,rgba(255,255,255,0.02),transparent)]">
            ...
            >
              <motion.img
                src={form.profilePic || "https://cdn-icons-png.flaticon.com/512/2922/2922510.png"}
                alt="Profile Preview"
                className="w-36 h-36 object-contain drop-shadow-[0_10px_40px_rgba(6,95,70,0.18)] rounded-full"
